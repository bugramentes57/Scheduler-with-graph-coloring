...
<body>
    ...
    if (isset($_POST["cmdaddnew"])) {
        $sql = "INSERT INTO dersler (ders_id, ders_ad)
                VALUES
                (:ders_id, :ders_ad)";
        ...
        $stmt->bindParam(':ders_ad', $_POST["ders_ad"]);
        

        if ($stmt->execute()) {
            echo "<script type= 'text/javascript'>alert('Kayıt başarıyla güncellendi');
                window.location.replace('edit2.php');</script>";
        } else {
    ...
    if ($editemployee == '') {
        ...
        $stmt = $baglanti->prepare($sql);
        $stmt->bindParam(':ders_id', $editemployee);
        $stmt->execute();
    ...
    if (isset($_POST["cmdelete"])) {
        $sql = "DELETE FROM dersler WHERE ders_id='$deleteemployee'";
    ...
    if (isset($_POST["cmdedit"])) {
        ...
        $sql = "UPDATE dersler SET ders_id=:ders_id, ders_ad=:ders_ad WHERE ders_id=:ders_id";
    ...
    <div class="container">
        ...
        <div class="table-wrapper">
            ...
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Ders <b>Ekleme</b></h2>
                    </div>
                    <div class="col-sm-6">
                        <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i
                                class="material-icons">🍳</i> <span>Ders Ekle</span></a>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <?php
                    $urunsor = $baglanti->prepare("SELECT * FROM dersler");
                    $urunsor->execute();
                    while ($uruncek = $urunsor->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?PHP echo $uruncek['ders_id'] ?>
                            </td>
                            <td>
                                <?PHP echo $uruncek['ders_ad'] ?>
                            </td>
                            

                            <td>
                                <a href="?editemployee=<?php echo $uruncek['ders_id']; ?>" class="edit"
                                    data-toggle="modal"><i class="material-icons" data-toggle="tooltip"
                                        title="Edit"></i></a>
                                <a href="?deleteemployee=<?php echo $uruncek['ders_id']; ?>" class="delete"
                                    data-toggle="modal"><i class="material-icons" data-toggle="tooltip"
                                        title="Delete"></i></a>
                            </td>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label>ders_id</label>
                                <input type="text" name="ders_id" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>ders_ad</label>
                                <input type="text" name="ders_ad" class="form-control" required>
                            </div>
                ...
                <div class="modal-content">
                    <form name="frmedit" action="" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label>ders_id</label>
                                <input type="text" name="ders_id" value="<?php echo $ders_id; ?>"
                                    class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>ders_ad</label>
                                <input type="text" name="ders_ad" value="<?php echo $ders_ad; ?>"
                                    class="form-control" required>
                            </div>
